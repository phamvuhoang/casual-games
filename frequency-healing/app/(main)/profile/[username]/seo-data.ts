...
export function profileDescription(record: ProfileSeoRecord | null) {
  if (!record) {
    return DEFAULT_DESCRIPTION;
  }

  return record.bio?.trim() || 'Explore a creator profile and their healing frequency compositions.';
}
